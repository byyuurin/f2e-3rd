...
<template>
  <div class="h-auto min-h-full flex flex-col">
    <div class="flex flex-wrap items-center px-5 py-2 mb-[2px] bg-light-50 dark:text-white dark:bg-dark-300">
      ...
      <div class="inline-flex items-center">
        <ui-button class="text-sm">
          <template #prefix>
            <svg-zmdi-favorite class="text-orange-400 dark:text-yellow-300" />
          </template>
          我的最愛
        </ui-button>
    ...
    <div class="p-10 text-center bg-light-50 dark:bg-transparent">
      <div class="text-xl">
        <a href="javascript:void(0);" class="inline-block px-2 text-true-gray-600 dark:text-current">
          <svg-brandico-facebook-rect />
        </a>
        <a href="javascript:void(0);" class="inline-block px-2 text-true-gray-600 dark:text-current">
          <svg-vs-line-square />
        </a>
        <a href="javascript:void(0);" class="inline-block px-2 text-true-gray-600 dark:text-current">
          <svg-fontisto-instagram />
        </a>
      </div>
      <div>台灣旅遊景點導覽</div>
    </div>
